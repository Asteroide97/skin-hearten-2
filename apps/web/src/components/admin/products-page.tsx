                    ...
                    {filteredProducts.map((product) => (
                      <tr className="align-top" key={product.id}>
                        ...
                        <td className="px-4 py-3 text-right">
                          <Link className="inline-flex items-center justify-center rounded-full border border-stone-300 px-4 py-2 text-xs font-semibold text-stone-800 transition hover:border-stone-500" href={`/admin/productos/${product.id}`}>
                            Ver detalle
                          </Link>
                        </td>
                      </tr>
